...
public class ProvidersMainActivity extends AppCompatActivity {
    ...
    public void onClickAddDetails(View view) {
        ...
        values.put(MyContentProvider.name, ((AppCompatEditText) findViewById(R.id.editText_content)).getText().toString());
    ...
    public void onClickShowDetails(View view) {
        AppCompatTextView resultView = (AppCompatTextView) findViewById(R.id.result);
